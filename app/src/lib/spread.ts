...
export function getSpread(
  ...
  return {
    ...
    spread: {
      ...
      // Ticket 04 fills the navigation targets and ticket 05 the audio
      // descriptor. The shapes are here so the UI and the tests can be written
      // against the finished seam.
